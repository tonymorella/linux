...
REM Computer name
SET MyComputerName=test

REM Unused IP adress (для перенаправлений)
SET NOURL=127.0.0.0
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

ECHO ********** Reg backup COPY to C:/RegBackup/Backup.reg 
...
ECHO ********** Disable Visual Effects and Solid Backround

REG ADD "HKCU\.DEFAULT\Software\Microsoft\Windows\CurrentVersion\Explorer\VisualEffects" /v "VisualFXSetting" /t REG_DWORD /d 2 /f
...
ECHO ********** Enable Windows Remote Management (HTTP-In)
...
call winrm quickconfig -transport:http -force
powershell -command "set-item wsman:\localhost\client\trustedhosts\*"
...
rem REG ADD "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Servicing" /v "LocalSourcePath" /t REG_EXPAND_SZ /d %NOURL% /f
rem REG ADD "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Servicing" /f
rem REG ADD "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Group Policy Objects\{7C0F6EBB-E44C-48D1-82A9-0561C4650831}Machine\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Servicing" /v "UseWindowsUpdate" /t REG_DWORD /d 2 /f
rem REG ADD "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Group Policy Objects\{7C0F6EBB-E44C-48D1-82A9-0561C4650831}Machine\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Servicing" /v "LocalSourcePath" /t REG_EXPAND_SZ /d %NOURL% /f
rem REG ADD "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Group Policy Objects\{7C0F6EBB-E44C-48D1-82A9-0561C4650831}Machine\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Servicing" /v "**del.RepairContentServerSource" /t REG_SZ /d " " /f
rem REG ADD "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Group Policy Objects\{7C0F6EBB-E44C-48D1-82A9-0561C4650831}Machine\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Servicing" /f

ECHO **********  Keep 'Has Stopped Working' windows from popping up - Terminate crashed mining software
REG ADD "HKLM\SOFTWARE\Policies\Microsoft\Windows\Windows Error Reporting" /v "DontShowUI" /t REG_DWORD /d 1 /f

ECHO ********** Disable tasks
rem SCHTASKS /Change /TN "\Microsoft\Windows\WS\WSTask" /DISABLE
SCHTASKS /Change /TN "\Microsoft\Windows\Work Folders\Work Folders Maintenance Work" /DISABLE
SCHTASKS /Change /TN "\Microsoft\Windows\Work Folders\Work Folders Logon Synchronization" /DISABLE
SCHTASKS /Change /TN "\Microsoft\Windows\WOF\WIM-Hash-Validation" /DISABLE
SCHTASKS /Change /TN "\Microsoft\Windows\WOF\WIM-Hash-Management" /DISABLE
rem SCHTASKS /Change /TN "\Microsoft\Windows\WindowsUpdate\sih" /DISABLE
...
rem SCHTASKS /Change /TN "\Microsoft\Windows\Shell\IndexerAutomaticMaintenance" /DISABLE
SCHTASKS /Change /TN "\Microsoft\Windows\SettingSync\NetworkStateChangeTask" /DISABLE
SCHTASKS /Change /TN "\Microsoft\Windows\SettingSync\BackgroundUploadTask" /DISABLE
rem SCHTASKS /Change /TN "\Microsoft\Windows\RemoteAssistance\RemoteAssistanceTask" /DISABLE
...
rem SCHTASKS /Change /TN "\Microsoft\Office\OfficeTelemetryAgentLogOn" /DISABLE
rem SCHTASKS /Change /TN "\Microsoft\Office\OfficeTelemetryAgentFallBack" /DISABLE
...
rem REG ADD "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management\PrefetchParameters" /v "EnablePrefetcher" /t REG_DWORD /d %Prefetch% /f
rem REG ADD "HKLM\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate" /v "DeferUpgrade" /t REG_DWORD /d 0 /f
REG ADD "HKLM\SOFTWARE\Policies\Microsoft\Windows\Personalization" /v "NoLockScreen" /t REG_DWORD /d 1 /f
rem REG ADD "HKLM\SOFTWARE\Policies\Microsoft\Windows\NetworkConnectivityStatusIndicator" /v "NoActiveProbe" /t REG_DWORD /d 1 /f
...
ECHO ********** Apply Internet Explorer 11 tweaks
...
rem ECHO ********** Disable Remote Assistance

rem REG ADD "HKLM\System\CurrentControlSet\Control\Remote Assistance" /v "fAllowToGetHelp" /t REG_DWORD /d "0" /f
rem REG ADD "HKLM\System\CurrentControlSet\Control\Remote Assistance" /v "fAllowFullControl" /t REG_DWORD /d "0" /f
rem REG ADD "HKLM\Software\Policies\Microsoft\Windows NT\Terminal Services" /v "fAllowToGetHelp" /t REG_DWORD /d "1" /f
rem REG ADD "HKLM\Software\Policies\Microsoft\Windows NT\Terminal Services" /v "fDenyTSConnections" /t REG_DWORD /d "0" /f
rem REG ADD "HKLM\Software\Policies\Microsoft\Windows NT\Terminal Services" /v "fAllowUnsolicitedFullControl" /t REG_DWORD /d "1" /f
rem REG ADD "HKLM\Software\Policies\Microsoft\Windows NT\Terminal Services" /v "fAllowUnsolicited" /t REG_DWORD /d "1" /f


rem ECHO ********** Enable Remote Desktop
...
ECHO ********** Enable classic control panel view
...
REG ADD "HKLM\SOFTWARE\Microsoft\PolicyManager\default\Experience" /v "AllowCortana" /t REG_DWORD /d 0 /f
...
rem SC config "AppXSvc" start= disabled
SC config "AppReadiness" start= disabled
SC config "CscService" start= disabled
SC config "MapsBroker" start= disabled
SC config "CertPropSvc" start= disabled
SC config "wscsvc" start= demand
rem SC config "SystemEventsBroker" start= demand
rem SC config "tiledatamodelsvc" start= demand
...
rem PowerShell -Command "Get-Service dmwappushservice | Set-Service -StartupType Disabled"
...
rem PowerShell -Command "Get-Service TrkWks | Set-Service -StartupType Disabled"
...
rem NET STOP dmwappushservice
NET STOP DPS
NET STOP RemoteRegistry
rem NET STOP TrkWks
rem NET STOP WMPNetworkSvc
NET STOP WSearch
NET STOP SysMain
...
REG ADD "HKCU\SOFTWARE\Microsoft\Tracing\WPPMediaPerApp\Skype\ETW" /v "WPPFilePath" /t REG_SZ /d "%%SYSTEMDRIVE%%\TEMP\WPPMedia" 
...
PowerShell -Command "Get-AppxProvisionedPackage -Online | Where-Object DisplayName -eq Microsoft.Xbox.TCUI | Remove-AppxProvisionedPackage -Online"
...
rem REG ADD "HKCU\Control Panel\International" /v "iMeasure" /t REG_SZ /d "0" /f
rem REG ADD "HKCU\Control Panel\International" /v "iNegCurr" /t REG_SZ /d "1" /f
rem REG ADD "HKCU\Control Panel\International" /v "iTime" /t REG_SZ /d "1" /f
rem REG ADD "HKCU\Control Panel\International" /v "sShortDate" /t REG_SZ /d "dd.MM.yyyy" /f
rem REG ADD "HKCU\Control Panel\International" /v "sShortTime" /t REG_SZ /d "HH:mm" /f
rem REG ADD "HKCU\Control Panel\International" /v "sTimeFormat" /t REG_SZ /d "H:mm:ss" /f
...
rem FIND /C /I "www.msn.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% www.msn.com>>%HOSTS%
rem FIND /C /I "www.msftncsi.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% www.msftncsi.com>>%HOSTS%
rem FIND /C /I "www.msdn.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% www.msdn.com>>%HOSTS%
rem FIND /C /I "www.microsoft.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% www.microsoft.com>>%HOSTS%
rem FIND /C /I "www.bing.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% www.bing.com>>%HOSTS%
rem FIND /C /I "wustats.microsoft.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% wustats.microsoft.com>>%HOSTS%
rem FIND /C /I "wns.notify.windows.com.akadns.net" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% wns.notify.windows.com.akadns.net>>%HOSTS%
rem rem FIND /C /I "windowsupdate.microsoft.com" %HOSTS%
rem rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% windowsupdate.microsoft.com>>%HOSTS%
rem rem FIND /C /I "windowsupdate.com" %HOSTS%
rem rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% windowsupdate.com>>%HOSTS%
rem FIND /C /I "win10.ipv6.microsoft.com.nsatc.net" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% win10.ipv6.microsoft.com.nsatc.net>>%HOSTS%
rem FIND /C /I "win10.ipv6.microsoft.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% win10.ipv6.microsoft.com>>%HOSTS%
rem FIND /C /I "wildcard.appex-rf.msn.com.edgesuite.net" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% wildcard.appex-rf.msn.com.edgesuite.net>>%HOSTS%
rem FIND /C /I "wes.df.telemetry.microsoft.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% wes.df.telemetry.microsoft.com>>%HOSTS%
rem FIND /C /I "watson.telemetry.microsoft.com.nsatc.net" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% watson.telemetry.microsoft.com.nsatc.net>>%HOSTS%
rem FIND /C /I "watson.telemetry.microsoft.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% watson.telemetry.microsoft.com>>%HOSTS%
rem FIND /C /I "watson.ppe.telemetry.microsoft.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% watson.ppe.telemetry.microsoft.com>>%HOSTS%
rem FIND /C /I "watson.microsoft.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% watson.microsoft.com>>%HOSTS%
rem FIND /C /I "watson.live.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% watson.live.com>>%HOSTS%
rem FIND /C /I "vortex.data.microsoft.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% vortex.data.microsoft.com>>%HOSTS%
rem FIND /C /I "vortex-win.data.microsoft.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% vortex-win.data.microsoft.com>>%HOSTS%
rem FIND /C /I "vortex-sandbox.data.microsoft.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% vortex-sandbox.data.microsoft.com>>%HOSTS%
rem FIND /C /I "vortex-cy2.metron.live.com.nsatc.net" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% vortex-cy2.metron.live.com.nsatc.net>>%HOSTS%
rem FIND /C /I "vortex-bn2.metron.live.com.nsatc.net" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% vortex-bn2.metron.live.com.nsatc.net>>%HOSTS%
rem FIND /C /I "view.atdmt.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% view.atdmt.com>>%HOSTS%
rem FIND /C /I "v10.vortex-win.data.microsoft.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% v10.vortex-win.data.microsoft.com>>%HOSTS%
rem FIND /C /I "v10.vortex-win.data.metron.life.com.nsatc.net" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% v10.vortex-win.data.metron.life.com.nsatc.net>>%HOSTS%
rem rem FIND /C /I "update.microsoft.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% update.microsoft.com>>%HOSTS%
rem FIND /C /I "ui.skype.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% ui.skype.com>>%HOSTS%
rem FIND /C /I "travel.tile.appex.bing.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% travel.tile.appex.bing.com>>%HOSTS%
rem FIND /C /I "telemetry.urs.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% telemetry.urs.microsoft.com>>%HOSTS%
rem FIND /C /I "telemetry.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% telemetry.microsoft.com>>%HOSTS%
rem FIND /C /I "telemetry.appex.bing.net:443" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% telemetry.appex.bing.net:443>>%HOSTS%
rem FIND /C /I "telemetry.appex.bing.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% telemetry.appex.bing.net>>%HOSTS%
rem FIND /C /I "telecommand.telemetry.microsoft.com.nsatc.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% telecommand.telemetry.microsoft.com.nsatc.net>>%HOSTS%
rem FIND /C /I "telecommand.telemetry.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% telecommand.telemetry.microsoft.com>>%HOSTS%
rem FIND /C /I "survey.watson.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% survey.watson.microsoft.com>>%HOSTS%
rem FIND /C /I "support.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% support.microsoft.com>>%HOSTS%
rem FIND /C /I "statsfe2.ws.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% statsfe2.ws.microsoft.com>>%HOSTS%
rem FIND /C /I "statsfe2.update.microsoft.com.akadns.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% statsfe2.update.microsoft.com.akadns.net>>%HOSTS%
rem FIND /C /I "statsfe1.ws.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% statsfe1.ws.microsoft.com>>%HOSTS%
rem FIND /C /I "static.2mdn.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% static.2mdn.net>>%HOSTS%
rem FIND /C /I "ssw.live.com.nsatc.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% ssw.live.com.nsatc.net>>%HOSTS%
rem FIND /C /I "ssw.live.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% ssw.live.com>>%HOSTS%
rem FIND /C /I "sqm.telemetry.microsoft.com.nsatc.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% sqm.telemetry.microsoft.com.nsatc.net>>%HOSTS%
rem FIND /C /I "sqm.telemetry.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% sqm.telemetry.microsoft.com>>%HOSTS%
rem FIND /C /I "sqm.df.telemetry.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% sqm.df.telemetry.microsoft.com>>%HOSTS%
rem FIND /C /I "sls.update.microsoft.com.akadns.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% sls.update.microsoft.com.akadns.net>>%HOSTS%
rem FIND /C /I "skydrive.wns.windows.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% skydrive.wns.windows.com>>%HOSTS%
rem FIND /C /I "skyapi.skyprod.akadns.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% skyapi.skyprod.akadns.net>>%HOSTS%
rem FIND /C /I "skyapi.live.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% skyapi.live.net>>%HOSTS%
rem FIND /C /I "settings.data.glbdns2.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% settings.data.glbdns2.microsoft.com>>%HOSTS%
rem FIND /C /I "settings-win.data.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% settings-win.data.microsoft.com>>%HOSTS%
rem FIND /C /I "settings-sandbox.data.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% settings-sandbox.data.microsoft.com>>%HOSTS%
rem FIND /C /I "services.wes.df.telemetry.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% services.wes.df.telemetry.microsoft.com>>%HOSTS%
rem FIND /C /I "secure.flashtalking.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% secure.flashtalking.com>>%HOSTS%
rem FIND /C /I "secure.adnxs.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% secure.adnxs.com>>%HOSTS%
rem FIND /C /I "schemas.microsoft.akadns.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% schemas.microsoft.akadns.net>>%HOSTS%
rem FIND /C /I "sO.2mdn.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% sO.2mdn.net>>%HOSTS%
rem FIND /C /I "s.gateway.messenger.live.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% s.gateway.messenger.live.com>>%HOSTS%
rem FIND /C /I "reports.wes.df.telemetry.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% reports.wes.df.telemetry.microsoft.com>>%HOSTS%
rem FIND /C /I "register.mesh.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% register.mesh.com>>%HOSTS%
rem FIND /C /I "redir.metaservices.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% redir.metaservices.microsoft.com>>%HOSTS%
rem FIND /C /I "rad.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% rad.msn.com>>%HOSTS%
rem FIND /C /I "rad.live.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% rad.live.com>>%HOSTS%
rem FIND /C /I "pricelist.skype.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% pricelist.skype.com>>%HOSTS%
rem FIND /C /I "preview.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% preview.msn.com>>%HOSTS%
rem FIND /C /I "pre.footprintpredict.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% pre.footprintpredict.com>>%HOSTS%
rem FIND /C /I "office.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% office.microsoft.com>>%HOSTS%
rem FIND /C /I "oca.telemetry.microsoft.com.nsatc.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% oca.telemetry.microsoft.com.nsatc.net>>%HOSTS%
rem FIND /C /I "oca.telemetry.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% oca.telemetry.microsoft.com>>%HOSTS%
rem FIND /C /I "msntest.serving-sys.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% msntest.serving-sys.com>>%HOSTS%
rem FIND /C /I "msnbot-65-55-108-23.search.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% msnbot-65-55-108-23.search.msn.com>>%HOSTS%
rem FIND /C /I "msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% msn.com>>%HOSTS%
rem FIND /C /I "msftncsi.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% msftncsi.com>>%HOSTS%
rem FIND /C /I "msedge.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% msedge.net>>%HOSTS%
rem FIND /C /I "msdn.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% msdn.microsoft.com>>%HOSTS%
rem FIND /C /I "msdn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% msdn.com>>%HOSTS%
rem rem FIND /C /I "microsoftupdate.microsoft.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% microsoftupdate.microsoft.com>>%HOSTS%
rem rem FIND /C /I "microsoftupdate.com" %HOSTS%
rem rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% microsoftupdate.com>>%HOSTS%
rem FIND /C /I "microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% microsoft.com>>%HOSTS%
rem FIND /C /I "m.hotmail.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% m.hotmail.com>>%HOSTS%
rem FIND /C /I "m.adnxs.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% m.adnxs.com>>%HOSTS%
rem FIND /C /I "login.live.com.nsatc.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% login.live.com.nsatc.net>>%HOSTS%
rem FIND /C /I "login.live.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% login.live.com>>%HOSTS%
rem FIND /C /I "live.rads.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% live.rads.msn.com>>%HOSTS%
rem FIND /C /I "lb1.www.ms.akadns.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% lb1.www.ms.akadns.net>>%HOSTS%
rem FIND /C /I "ipv6.msftncsi.com.edgesuite.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% ipv6.msftncsi.com.edgesuite.net>>%HOSTS%
rem FIND /C /I "ipv6.msftncsi.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% ipv6.msftncsi.com>>%HOSTS%
rem FIND /C /I "i1.services.social.microsoft.com.nsatc.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% i1.services.social.microsoft.com.nsatc.net>>%HOSTS%
rem FIND /C /I "i1.services.social.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% i1.services.social.microsoft.com>>%HOSTS%
rem FIND /C /I "h1.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% h1.msn.com>>%HOSTS%
rem FIND /C /I "go.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% go.microsoft.com>>%HOSTS%
rem FIND /C /I "g.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% g.msn.com>>%HOSTS%
rem FIND /C /I "flex.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% flex.msn.com>>%HOSTS%
rem FIND /C /I "feedback.windows.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% feedback.windows.com>>%HOSTS%
rem FIND /C /I "feedback.search.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% feedback.search.microsoft.com>>%HOSTS%
rem FIND /C /I "feedback.microsoft-hohm.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% feedback.microsoft-hohm.com>>%HOSTS%
rem FIND /C /I "fe3.delivery.mp.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% fe3.delivery.mp.microsoft.com>>%HOSTS%
rem FIND /C /I "fe3.delivery.dsp.mp.microsoft.com.nsatc.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% fe3.delivery.dsp.mp.microsoft.com.nsatc.net>>%HOSTS%
rem FIND /C /I "fe2.update.microsoft.com.akadns.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% fe2.update.microsoft.com.akadns.net>>%HOSTS%
rem FIND /C /I "en-us.appex-rf.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% en-us.appex-rf.msn.com>>%HOSTS%
rem FIND /C /I "ec.atdmt.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% ec.atdmt.com>>%HOSTS%
rem FIND /C /I "download.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% download.microsoft.com>>%HOSTS%t
rem FIND /C /I "dns.msftncsi.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% dns.msftncsi.com>>%HOSTS%
rem FIND /C /I "directory.services.live.com.akadns.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% directory.services.live.com.akadns.net>>%HOSTS%
rem FIND /C /I "directory.services.live.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% directory.services.live.com>>%HOSTS%
rem FIND /C /I "diagnostics.support.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% diagnostics.support.microsoft.com>>%HOSTS%
rem FIND /C /I "df.telemetry.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% df.telemetry.microsoft.com>>%HOSTS%
rem FIND /C /I "db3aqu.atdmt.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% db3aqu.atdmt.com>>%HOSTS%
rem FIND /C /I "cs1.wpc.v0cdn.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% cs1.wpc.v0cdn.net>>%HOSTS%
rem FIND /C /I "corpext.msitadfs.glbdns2.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% corpext.msitadfs.glbdns2.microsoft.com>>%HOSTS%
rem FIND /C /I "corp.sts.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% corp.sts.microsoft.com>>%HOSTS%
rem FIND /C /I "compatexchange.cloudapp.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% compatexchange.cloudapp.net>>%HOSTS%
rem FIND /C /I "client.wns.windows.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% client.wns.windows.com>>%HOSTS%
rem FIND /C /I "choice.microsoft.com.nsatc.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% choice.microsoft.com.nsatc.net>>%HOSTS%
rem FIND /C /I "choice.microsoft.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% choice.microsoft.com>>%HOSTS%
rem FIND /C /I "cds26.ams9.msecn.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% cds26.ams9.msecn.net>>%HOSTS%
rem FIND /C /I "cdn.atdmt.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% cdn.atdmt.com>>%HOSTS%
rem FIND /C /I "c.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% c.msn.com>>%HOSTS%
rem FIND /C /I "c.atdmt.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% c.atdmt.com>>%HOSTS%
rem FIND /C /I "bs.serving-sys.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% bs.serving-sys.com>>%HOSTS%
rem FIND /C /I "bl3302geo.storage.dkyprod.akadns.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% bl3302geo.storage.dkyprod.akadns.net>>%HOSTS%
rem FIND /C /I "bl3302.storage.live.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% bl3302.storage.live.com>>%HOSTS%
rem FIND /C /I "b.rad.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% b.rad.msn.com>>%HOSTS%
rem FIND /C /I "b.ads2.msads.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% b.ads2.msads.net>>%HOSTS%
rem FIND /C /I "b.ads1.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% b.ads1.msn.com>>%HOSTS%
rem FIND /C /I "az512334.vo.msecnd.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% az512334.vo.msecnd.net>>%HOSTS%
rem FIND /C /I "az361816.vo.msecnd.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% az361816.vo.msecnd.net>>%HOSTS%
rem FIND /C /I "apps.skype.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% apps.skype.com>>%HOSTS%
rem FIND /C /I "any.edge.bing.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% any.edge.bing.com>>%HOSTS%
rem FIND /C /I "americas2.notify.windows.com.akadns.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% americas2.notify.windows.com.akadns.net>>%HOSTS%
rem FIND /C /I "aka-cdn-ns.adtech.de" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% aka-cdn-ns.adtech.de>>%HOSTS%
rem FIND /C /I "aidps.atdmt.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% aidps.atdmt.com>>%HOSTS%
rem FIND /C /I "ads1.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% ads1.msn.com>>%HOSTS%
rem FIND /C /I "ads1.msads.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% ads1.msads.net>>%HOSTS%
rem FIND /C /I "ads.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% ads.msn.com>>%HOSTS%
rem FIND /C /I "adnxs.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% adnxs.com>>%HOSTS%
rem FIND /C /I "adnexus.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% adnexus.net>>%HOSTS%
rem FIND /C /I "ad.doubleclick.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% ad.doubleclick.net>>%HOSTS%
rem FIND /C /I "ac3.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% ac3.msn.com>>%HOSTS%
rem FIND /C /I "a978.i6g1.akamai.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% a978.i6g1.akamai.net>>%HOSTS%
rem FIND /C /I "a.rad.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% a.rad.msn.com>>%HOSTS%
rem FIND /C /I "a.ads2.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% a.ads2.msn.com>>%HOSTS%
rem FIND /C /I "a.ads2.msads.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% a.ads2.msads.net>>%HOSTS%
rem FIND /C /I "a.ads1.msn.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% a.ads1.msn.com>>%HOSTS%
rem FIND /C /I "a-msedge.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% a-msedge.net>>%HOSTS%
rem FIND /C /I "a-0009.a-msedge.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% a-0009.a-msedge.net>>%HOSTS%
rem FIND /C /I "a-0008.a-msedge.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% a-0008.a-msedge.net>>%HOSTS%
rem FIND /C /I "a-0007.a-msedge.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% a-0007.a-msedge.net>>%HOSTS%
rem FIND /C /I "a-0006.a-msedge.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% a-0006.a-msedge.net>>%HOSTS%
rem FIND /C /I "a-0005.a-msedge.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% a-0005.a-msedge.net>>%HOSTS%
rem FIND /C /I "a-0004.a-msedge.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% a-0004.a-msedge.net>>%HOSTS%
rem FIND /C /I "a-0003.a-msedge.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% a-0003.a-msedge.net>>%HOSTS%
rem FIND /C /I "a-0002.a-msedge.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% a-0002.a-msedge.net>>%HOSTS%
rem FIND /C /I "a-0001.a-msedge.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% a-0001.a-msedge.net>>%HOSTS%
rem FIND /C /I "OneSettings-bn2.metron.live.com.nsatc.net" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% OneSettings-bn2.metron.live.com.nsatc.net>>%HOSTS%
rem FIND /C /I "BN1WNS2011508.wns.windows.com" %HOSTS%
rem IF %ERRORLEVEL% NEQ 0 ECHO ^%NOURL% BN1WNS2011508.wns.windows.com>>%HOSTS%
ATTRIB +r "%WINDIR%\system32\drivers\etc\hosts"
